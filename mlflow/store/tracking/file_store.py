...
class FileStore(AbstractStore):
    ...
    def get_run(self, run_id, metrics_whitelist=None, params_whitelist=None, tags_whitelist=None):
        """
    ...
    def _search_runs(self, experiment_ids, filter_string, run_view_type, max_results, order_by,
        ...
        for experiment_id in experiment_ids:
            ...
            runs.extend(self.get_run(r.run_id, metrics_whitelist, params_whitelist, tags_whitelist) for r in run_infos)
