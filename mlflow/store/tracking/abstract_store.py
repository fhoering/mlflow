...
class AbstractStore:
    ...
    def search_runs(self, experiment_ids, filter_string, run_view_type,
        ...
        """
        runs, token, total_run_count = self._search_runs(experiment_ids, filter_string, run_view_type, max_results,
                                        order_by, page_token, metrics_whitelist, params_whitelist, tags_whitelist)
