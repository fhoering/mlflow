...
_HARDDELETERUN_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.HardDeleteRun.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_HARDDELETERUN = _descriptor.Descriptor(
  name='HardDeleteRun',
  full_name='mlflow.HardDeleteRun',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_id', full_name='mlflow.HardDeleteRun.run_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_HARDDELETERUN_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_UPDATEARTIFACTSLOCATION_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.UpdateArtifactsLocation.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_UPDATEARTIFACTSLOCATION = _descriptor.Descriptor(
  name='UpdateArtifactsLocation',
  full_name='mlflow.UpdateArtifactsLocation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_id', full_name='mlflow.UpdateArtifactsLocation.run_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\370\206\031\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='new_artifacts_location', full_name='mlflow.UpdateArtifactsLocation.new_artifacts_location', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_UPDATEARTIFACTSLOCATION_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_GETVCSREGEX_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.GetVcsRegex.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='vcs_regex', full_name='mlflow.GetVcsRegex.Response.vcs_regex', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETVCSREGEX = _descriptor.Descriptor(
  name='GetVcsRegex',
  full_name='mlflow.GetVcsRegex',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
  ...
  nested_types=[_GETVCSREGEX_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_GETVCSURL_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.GetVcsUrl.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='vcs_url', full_name='mlflow.GetVcsUrl.Response.vcs_url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETVCSURL = _descriptor.Descriptor(
  name='GetVcsUrl',
  full_name='mlflow.GetVcsUrl',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='mlflow.GetVcsUrl.type', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_GETVCSURL_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_HARDDELETERUN_RESPONSE.containing_type = _HARDDELETERUN
...
_UPDATEARTIFACTSLOCATION_RESPONSE.containing_type = _UPDATEARTIFACTSLOCATION
_GETVCSREGEX_RESPONSE.containing_type = _GETVCSREGEX
_GETVCSURL_RESPONSE.containing_type = _GETVCSURL
...
DESCRIPTOR.message_types_by_name['HardDeleteRun'] = _HARDDELETERUN
...
DESCRIPTOR.message_types_by_name['UpdateArtifactsLocation'] = _UPDATEARTIFACTSLOCATION
DESCRIPTOR.message_types_by_name['GetVcsRegex'] = _GETVCSREGEX
DESCRIPTOR.message_types_by_name['GetVcsUrl'] = _GETVCSURL
...
HardDeleteRun = _reflection.GeneratedProtocolMessageType('HardDeleteRun', (_message.Message,), dict(
...
UpdateArtifactsLocation = _reflection.GeneratedProtocolMessageType('UpdateArtifactsLocation', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _UPDATEARTIFACTSLOCATION_RESPONSE,
    __module__ = 'service_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.UpdateArtifactsLocation.Response)
    ))
  ,
  DESCRIPTOR = _UPDATEARTIFACTSLOCATION,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.UpdateArtifactsLocation)
  ))
_sym_db.RegisterMessage(UpdateArtifactsLocation)
_sym_db.RegisterMessage(UpdateArtifactsLocation.Response)

GetVcsRegex = _reflection.GeneratedProtocolMessageType('GetVcsRegex', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _GETVCSREGEX_RESPONSE,
    __module__ = 'service_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.GetVcsRegex.Response)
    ))
  ,
  DESCRIPTOR = _GETVCSREGEX,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.GetVcsRegex)
  ))
_sym_db.RegisterMessage(GetVcsRegex)
_sym_db.RegisterMessage(GetVcsRegex.Response)

GetVcsUrl = _reflection.GeneratedProtocolMessageType('GetVcsUrl', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _GETVCSURL_RESPONSE,
    __module__ = 'service_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.GetVcsUrl.Response)
    ))
  ,
  DESCRIPTOR = _GETVCSURL,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.GetVcsUrl)
  ))
_sym_db.RegisterMessage(GetVcsUrl)
_sym_db.RegisterMessage(GetVcsUrl.Response)
...
_UPDATEARTIFACTSLOCATION.fields_by_name['run_id']._options = None
_UPDATEARTIFACTSLOCATION.fields_by_name['new_artifacts_location']._options = None
_UPDATEARTIFACTSLOCATION._options = None
_GETVCSREGEX._options = None
_GETVCSURL._options = None
...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='hardDeleteRun',
    full_name='mlflow.MlflowService.hardDeleteRun',
    index=10,
    containing_service=None,
    input_type=_HARDDELETERUN,
    output_type=_HARDDELETERUN_RESPONSE,
    serialized_options=_b('\362\206\031i\n%\n\004POST\022\027/mlflow/runs/harddelete\032\004\010\002\020\000\n-\n\004POST\022\037/preview/mlflow/runs/harddelete\032\004\010\002\020\000\020\001*\017Hard Delete Run'),
  ),
  _descriptor.MethodDescriptor(
    name='restoreRun',
  ...
  _descriptor.MethodDescriptor(
    name='updateArtifactsLocation',
    full_name='mlflow.MlflowService.updateArtifactsLocation',
    index=21,
    containing_service=None,
    input_type=_UPDATEARTIFACTSLOCATION,
    output_type=_UPDATEARTIFACTSLOCATION_RESPONSE,
    serialized_options=_b('\362\206\031\217\001\n3\n\003PUT\022&/mlflow/runs/update-artifacts-location\032\004\010\002\020\000\n;\n\003PUT\022./preview/mlflow/runs/update-artifacts-location\032\004\010\002\020\000\020\001*\031Update Artifacts Location'),
  ),
  _descriptor.MethodDescriptor(
    name='logBatch',
  ...
  _descriptor.MethodDescriptor(
    name='vcsRegex',
    full_name='mlflow.MlflowService.vcsRegex',
    index=23,
    containing_service=None,
    input_type=_GETVCSREGEX,
    output_type=_GETVCSREGEX_RESPONSE,
    serialized_options=_b('\362\206\031i\n&\n\003GET\022\031/mlflow/private_vcs/regex\032\004\010\002\020\000\n&\n\003GET\022\031/mlflow/private_vcs/regex\032\004\010\002\020\000\020\001*\025Get Private VCS Regex'),
  ),
  _descriptor.MethodDescriptor(
    name='vcsUrl',
    full_name='mlflow.MlflowService.vcsUrl',
    index=24,
    containing_service=None,
    input_type=_GETVCSURL,
    output_type=_GETVCSURL_RESPONSE,
    serialized_options=_b('\362\206\031d\n$\n\003GET\022\027/mlflow/private_vcs/url\032\004\010\002\020\000\n$\n\003GET\022\027/mlflow/private_vcs/url\032\004\010\002\020\000\020\001*\024Get Private VCS Urls'),
  ),
])
